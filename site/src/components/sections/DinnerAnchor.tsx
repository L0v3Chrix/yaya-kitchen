    ...
    <>
      ...
      <SplitSection
        ...
        content={
          <>
            <p className="mb-4">
              The heart of each YaYa&apos;s Kitchen week is dinner. Every basket includes 
              fully prepared dinners designed to support your family through the week with 
              less planning, less prep, and more ease.
            </p>
            <p className="mb-4">
              Each dinner is thoughtfully cooked with clean ingredients and organic when 
              possible, meant to replace fast food, frozen meals, and end-of-day decision fatigue.
            </p>
            <p>
              Order 2 or 3 dinner choices each week, every other week, or monthly.
            </p>
          </>
        }
      />
